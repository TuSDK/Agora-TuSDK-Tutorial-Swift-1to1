...
class VideoChatViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        TuSDKVideoPreProcessing.registerVideoPreprocessing(self.agoraKit)
        
    }
    func initTUSDK() {
        TuSDKManager.shared().configTuSDKView(withSuperView: self.view)
    }
    ...
    func leaveChannel() {
        ...
        TuSDKVideoPreProcessing.deregisterVideoPreprocessing(self.agoraKit)
